...
namespace Chamados.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public DepartamentosController(ChamadosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DepId,DepNome,DepEmail")] Departamento departamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DepId,DepNome,DepEmail")] Departamento departamento)
        {
